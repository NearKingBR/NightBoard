...
exports.run = (client, message, args)  => {
    ...
    if (message.mentions.roles.size <1) return message.reply("**Mencione o Cargo staff**");
    if (message.mentions.users.size < 1) return message.reply("**Mencione alguem para eu dar o cargo staff!**");
